...
exports.createRuntime = exports.MockRuntime = exports.sleep = void 0;
const runtime_engine_1 = require("@midwayjs/runtime-engine");
const trigger_1 = require("./trigger");
const path_1 = require("path");
function sleep(sec = 1000) {
...
class MockRuntime {
    constructor(options = {}) {
        ...
        if (this.options.bootstrap || this.options.runtime || this.options.events) {
            this.bootstrap = this.options.bootstrap
                ...
                : new runtime_engine_1.BaseBootstrap({
        ...
        if (this.bootstrap) {
            ...
            if (this.options.events) {
                for (const event of this.options.events) {
                    this.engine.addEventExtension(async (runtime) => {
                        return event;
                    });
                }
            }
    ...
    async invoke(...args) {
        let newArgs;
        if (args[0] && args[0] instanceof trigger_1.BaseTrigger) {
            this.trigger = args[0];
    ...
    async invokeHandlerMethod(newArgs) {
        if (this.runtime) {
            ...
            if (typeof this.handler === 'function') {
                ...
                const { fileName, handler } = (0, runtime_engine_1.getHandlerMeta)(this.handler || 'index.handler');
                handlerMethod = (0, runtime_engine_1.getHandlerMethod)((0, path_1.join)(this.options.functionDir, fileName), handler);
            }
