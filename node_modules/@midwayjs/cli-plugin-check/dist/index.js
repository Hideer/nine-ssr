...
class CheckPlugin extends command_core_1.BasePlugin {
    ...
    async start() {
        ...
        if (this.projectType === ProjectType.FaaS) {
            ...
            if (midwayConfig) {
                const modInfo = (0, command_core_1.findNpmModule)(cwd, '@midwayjs/hooks-core');
                if (modInfo) {
    ...
    async getRuleList() {
        ...
        if (this.projectType === ProjectType.FaaS) {
            ruleList.push(this.ruleTSConfig(), await this.ruleFaaSDecorator(), this.ruleFYaml());
        }
    ...
    async packageJson() {
        ...
        const pkgExists = (0, fs_1.existsSync)(pkgJsonFile);
        let pkjJson;
        if (pkgExists) {
            pkjJson = JSON.parse((0, fs_1.readFileSync)(pkgJsonFile).toString());
        }
        return runner => {
            runner
    ...
    async projectStruct() {
        ...
        return runner => {
            runner
                ...
                const configurationData = (0, fs_1.readFileSync)(configuration).toString();
