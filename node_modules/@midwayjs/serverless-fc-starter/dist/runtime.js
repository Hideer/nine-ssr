...
class FCRuntime extends runtime_engine_1.ServerlessLightRuntime {
    ...
    async wrapperWebInvoker(handler, req, res, context) {
        // for web
        const isHTTPMode = req.constructor.name === 'IncomingMessage' ||
        ...
        if (isHTTPMode) {
            ...
            // api gateway
            newReq = new serverless_http_parser_1.HTTPRequest(req, context);
        }
        // if (ctx.method === 'GET') {
    ...
    async wrapperEventInvoker(handler, event, context = {}) {
        const args = [context];
        if (event && event[runtime_engine_1.FAAS_ARGS_KEY]) {
            args.push(event[runtime_engine_1.FAAS_ARGS_KEY]);
        }
        else {
            // 阿里云无触发器，入参是 buffer
    ...
    getFunctionName() {
        var _a, _b, _c;
        return ((_c = (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.initContext) === null || _b === void 0 ? void 0 : _b.function) === null || _c === void 0 ? void 0 : _c.name) || super.getFunctionName();
    }
    getFunctionServiceName() {
        var _a, _b, _c;
        return (((_c = (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.initContext) === null || _b === void 0 ? void 0 : _b.service) === null || _c === void 0 ? void 0 : _c.name) || super.getFunctionServiceName());
    }
}
exports.FCRuntime = FCRuntime;
