...
exports.request = {
    ...
    get originEvent() {
        var _a, _b;
        return ((_b = (_a = this.req).getOriginEvent) === null || _b === void 0 ? void 0 : _b.call(_a)) || {};
    },
    get originContext() {
        var _a, _b;
        return ((_b = (_a = this.req).getOriginContext) === null || _b === void 0 ? void 0 : _b.call(_a)) || {};
    },
    get ip() {
        var _a;
        return ((_a = this.req) === null || _a === void 0 ? void 0 : _a.clientIP) || this.req.ip;
    },
    get url() {
        return this.req.url;
    },
    ...
    get query() {
        var _a;
        return ((_a = this.req) === null || _a === void 0 ? void 0 : _a.queries) || this.req.query;
    },
    get body() {
        ...
        switch (type_is_1.is(this.get('content-type'), ['urlencoded', 'json'])) {
            case 'json':
                try {
    ...
    is(type, ...types) {
        return type_is_1.is(this.get('content-type'), type, ...types);
    },
    /**
