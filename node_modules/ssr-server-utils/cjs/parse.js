...
const getPrefix = () => {
    let { prefix } = (0, loadConfig_1.loadConfig)();
    if (prefix) {
        prefix = (0, cwd_1.normalizeStartPath)(prefix);
    }
    return prefix;
};
const normalizePath = (path, base) => {
...
const parseFeRoutes = async () => {
    ...
    const prefix = getPrefix();
    const isVue = require((0, path_1.join)(cwd, './package.json')).dependencies.vue;
    ...
    if (!declaretiveRoutes) {
        ...
        if (isVue) {
            ...
            const accessVueApp = await (0, cwd_1.accessFile)((0, path_1.join)((0, cwd_1.getFeDir)(), './components/layout/App.vue'));
            const layoutFetch = await (0, cwd_1.accessFile)((0, path_1.join)((0, cwd_1.getFeDir)(), './components/layout/fetch.ts'));
            const store = await (0, cwd_1.accessFile)((0, path_1.join)((0, cwd_1.getFeDir)(), './store/index.ts'));
      ...
      // The file is provisional，don't depend on it 
        ...
        `;
            ...
            // React 场景
            const accessReactApp = await (0, cwd_1.accessFile)((0, path_1.join)((0, cwd_1.getFeDir)(), './components/layout/App.tsx'));
            const layoutFetch = await (0, cwd_1.accessFile)((0, path_1.join)((0, cwd_1.getFeDir)(), './components/layout/fetch.ts'));
...
const writeRoutes = async (routes) => {
    await fs_1.promises.writeFile((0, path_1.resolve)(cwd, './build/ssr-temporary-routes.js'), routes);
};
