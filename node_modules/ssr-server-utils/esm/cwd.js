...
const copyViteConfig = async () => {
    ...
    if (!result) {
        ...
        const buildAlias = (_b = (_a = require(resolve(getCwd(), './vite.config.js')).resolve) === null || _a === void 0 ? void 0 : _a.alias) === null || _b === void 0 ? void 0 : _b._build;
        if (!buildAlias) {
...
export { getCwd, getFeDir, getPagesDir, getUserConfig, isFaaS, loadPlugin, getLocalNodeModules, processError, accessFile, copyViteConfig, checkVite, execPromisify, readAsyncChunk, addAsyncChunk, cryptoAsyncChunkName, normalizeStartPath, normalizeEndPath, copyReactContext };
