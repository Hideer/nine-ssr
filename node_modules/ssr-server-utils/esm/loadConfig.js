...
const loadConfig = () => {
    ...
    const mode = 'ssr';
    const stream = false;
    const publicPath = ((_a = userConfig.publicPath) === null || _a === void 0 ? void 0 : _a.startsWith('http')) ? userConfig.publicPath : normalizeStartPath((_b = userConfig.publicPath) !== null && _b !== void 0 ? _b : '/');
